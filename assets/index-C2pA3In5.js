(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const r of document.querySelectorAll('link[rel="modulepreload"]'))l(r);new MutationObserver(r=>{for(const s of r)if(s.type==="childList")for(const n of s.addedNodes)n.tagName==="LINK"&&n.rel==="modulepreload"&&l(n)}).observe(document,{childList:!0,subtree:!0});function i(r){const s={};return r.integrity&&(s.integrity=r.integrity),r.referrerPolicy&&(s.referrerPolicy=r.referrerPolicy),r.crossOrigin==="use-credentials"?s.credentials="include":r.crossOrigin==="anonymous"?s.credentials="omit":s.credentials="same-origin",s}function l(r){if(r.ep)return;r.ep=!0;const s=i(r);fetch(r.href,s)}})();const u=[{id:"vertical-trace",name:"Vertical Trace",viewBox:"0 0 126 577",width:150,markup:`<g transform="translate(31, 380) scale(-1, 1) translate(-31, -380) translate(0, 194)">
...
<circle class="node" cx="178" cy="222" r="4"/>`},{id:"motherboard",name:"Motherboard",viewBox:"0 0 280 220",width:300,markup:`<rect x="96" y="62" width="88" height="88" rx="12"/>
...
<circle class="node" cx="150" cy="72" r="5"/>`},{id:"antenna-array",name:"Antenna Array",viewBox:"0 0 240 240",width:260,markup:`<path d="M120 202V118"/>
...
<circle class="node" cx="188" cy="146" r="4"/>`},{id:"hex-core",name:"Hex Core",viewBox:"0 0 260 240",width:280,markup:`<path d="M130 34l76 44v88l-76 44-76-44V78z"/>
<path d="M130 34v70"/>
...
<circle class="node" cx="236" cy="166" r="5"/>`},{id:"edge-frame",name:"Edge Frame",viewBox:"0 0 280 220",width:300,markup:`<path d="M32 34h72l20 20h32l20-20h72"/>
...
<circle class="node" cx="226" cy="112" r="4"/>`},{id:"serpentine",name:"Serpentine",viewBox:"0 0 220 300",width:230,markup:`<path d="M46 24h92c28 0 42 14 42 38s-14 38-42 38H82c-28 0-42 14-42 38s14 38 42 38h58c28 0 42 14 42 38s-14 38-42 38H52"/>
<path d="M82 100v28"/>
<path d="M140 176v28"/>
<path d="M110 24V8"/>
<path d="M110 252v32"/>
...
<circle class="node" cx="110" cy="284" r="4"/>`},{id:"connector",name:"Connector",viewBox:"0 0 300 190",width:320,markup:`<rect x="36" y="58" width="72" height="74" rx="10"/>
...
<circle class="node" cx="174" cy="162" r="4"/>`},{id:"orbit-bus",name:"Orbit Bus",viewBox:"0 0 260 260",width:280,markup:`<circle class="node" cx="130" cy="130" r="20"/>
...
<circle class="node" cx="188" cy="218" r="4"/>`},{id:"maze",name:"Maze",viewBox:"0 0 260 220",width:280,markup:`<path d="M24 34h74v38H62v38h84V72h54V34h36"/>
...
<circle class="node" cx="146" cy="184" r="5"/>`}],c={source:"preset",circuitId:u[0].id,animationMode:"flow",animationDirection:"normal",speed:5,dash:150,stroke:2,glow:8,stagger:.16,scale:100,circuitColor:"#3f7cff",opacity:1,lineCap:"round",lineJoin:"round",nodeFill:"background",backgroundMode:"solid",backgroundPattern:"none",backgroundColor:"#0b111b",backgroundAlt:"#18243b",stagePadding:52,customSvg:""},e={stageWrap:document.querySelector("#stageWrap"),stage:document.querySelector("#stage"),circuitSelect:document.querySelector("#circuitSelect"),sourceButtons:[...document.querySelectorAll("[data-source]")],customSvgField:document.querySelector("#customSvgField"),customSvg:document.querySelector("#customSvg"),validationMessage:document.querySelector("#validationMessage"),animationMode:document.querySelector("#animationMode"),animationDirection:document.querySelector("#animationDirection"),speed:document.querySelector("#speed"),dash:document.querySelector("#dash"),stroke:document.querySelector("#stroke"),glow:document.querySelector("#glow"),stagger:document.querySelector("#stagger"),scale:document.querySelector("#scale"),circuitColor:document.querySelector("#circuitColor"),opacity:document.querySelector("#opacity"),lineCap:document.querySelector("#lineCap"),lineJoin:document.querySelector("#lineJoin"),nodeFill:document.querySelector("#nodeFill"),backgroundMode:document.querySelector("#backgroundMode"),backgroundPattern:document.querySelector("#backgroundPattern"),backgroundColor:document.querySelector("#backgroundColor"),backgroundAlt:document.querySelector("#backgroundAlt"),stagePadding:document.querySelector("#stagePadding"),speedValue:document.querySelector("#speedValue"),dashValue:document.querySelector("#dashValue"),strokeValue:document.querySelector("#strokeValue"),glowValue:document.querySelector("#glowValue"),staggerValue:document.querySelector("#staggerValue"),scaleValue:document.querySelector("#scaleValue"),opacityValue:document.querySelector("#opacityValue"),paddingValue:document.querySelector("#paddingValue"),svgOutput:document.querySelector("#svgOutput"),cssOutput:document.querySelector("#cssOutput"),embedOutput:document.querySelector("#embedOutput"),aiOutput:document.querySelector("#aiOutput"),copyButtons:[...document.querySelectorAll("[data-copy]")]};function x(){e.circuitSelect.innerHTML=u.map(t=>`<option value="${t.id}">${t.name}</option>`).join(""),o(e.circuitSelect,"circuitId"),o(e.animationMode,"animationMode"),o(e.animationDirection,"animationDirection"),o(e.speed,"speed",Number),o(e.dash,"dash",Number),o(e.stroke,"stroke",Number),o(e.glow,"glow",Number),o(e.stagger,"stagger",Number),o(e.scale,"scale",Number),o(e.circuitColor,"circuitColor"),o(e.opacity,"opacity",Number),o(e.lineCap,"lineCap"),o(e.lineJoin,"lineJoin"),o(e.nodeFill,"nodeFill"),o(e.backgroundMode,"backgroundMode"),o(e.backgroundPattern,"backgroundPattern"),o(e.backgroundColor,"backgroundColor"),o(e.backgroundAlt,"backgroundAlt"),o(e.stagePadding,"stagePadding",Number),e.sourceButtons.forEach(t=>{t.addEventListener("click",()=>{c.source=t.dataset.source,d()})}),e.customSvg.addEventListener("input",t=>{c.customSvg=t.target.value,d()}),e.copyButtons.forEach(t=>{t.addEventListener("click",async()=>{const a=S(t.dataset.copy);await C(a);const i=t.textContent;t.textContent="Copied",window.setTimeout(()=>{t.textContent=i},1200)})}),d()}function o(t,a,i=l=>l){t.addEventListener("input",l=>{c[a]=i(l.target.value),d()})}function g(){return u.find(t=>t.id===c.circuitId)??u[0]}function m(){if(c.source==="custom"){const a=h(c.customSvg);return a.ok?a.svg:null}const t=g();return`<svg class="animated-circuit circuit-${c.animationMode}" viewBox="${t.viewBox}" role="img" aria-label="${V(t.name)} animated circuit" style="width:${t.width}px">
${t.markup}
</svg>`}function h(t){if(!t.trim())return{ok:!1,message:"Paste an SVG to preview and export it."};const i=new DOMParser().parseFromString(t,"image/svg+xml"),l=i.querySelector("parsererror"),r=i.querySelector("svg");return l||!r?{ok:!1,message:"That does not look like valid SVG markup yet."}:(r.classList.add("animated-circuit",`circuit-${c.animationMode}`),r.setAttribute("role","img"),r.setAttribute("aria-label","Custom animated circuit"),{ok:!0,svg:r.outerHTML})}function d(){const t=m(),a=c.source==="custom"?h(c.customSvg):{ok:!0,message:""};e.sourceButtons.forEach(n=>{n.classList.toggle("active",n.dataset.source===c.source)}),e.customSvgField.classList.toggle("visible",c.source==="custom"),e.validationMessage.textContent=a.ok?"":a.message,e.validationMessage.classList.toggle("visible",!a.ok),f(),k(),e.stage.innerHTML=t??'<p class="empty-preview">Paste a valid SVG to see it animate.</p>';const i=e.stage.querySelector("svg");i&&(i.classList.remove("circuit-flow","circuit-pulse","circuit-draw","circuit-shimmer","circuit-paused"),i.classList.add("animated-circuit",`circuit-${c.animationMode}`),i.style.width=`${Math.max(120,c.scale*2.4)}px`,v(i));const l=w(),r=t??"",s=`<style>
${l}
</style>
<div class="circuit-surface circuit-pattern-${c.backgroundPattern}">
${r}
</div>`;e.svgOutput.textContent=r,e.cssOutput.textContent=l,e.embedOutput.textContent=s,e.aiOutput.textContent=b(r,l)}function v(t){[...t.querySelectorAll("path, circle, rect, polyline, line")].forEach((i,l)=>{const r=M(i),s=Math.max(8,Math.min(r*.32,c.dash)),n=Math.max(r,c.dash*4),p=n+s;i.style.setProperty("--trace-length",r.toFixed(2)),i.style.setProperty("--trace-dash",s.toFixed(2)),i.style.setProperty("--trace-gap",n.toFixed(2)),i.style.setProperty("--trace-start",p.toFixed(2)),i.style.setProperty("--trace-end",`-${p.toFixed(2)}`),i.style.setProperty("--trace-delay",`${l*-c.stagger}s`)})}function M(t){if(typeof t.getTotalLength=="function")try{return Math.max(t.getTotalLength(),1)}catch{return c.dash}return c.dash}function f(){e.speedValue.textContent=`${c.speed.toFixed(1)}s`,e.dashValue.textContent=`${c.dash}px`,e.strokeValue.textContent=`${c.stroke.toFixed(2)}px`,e.glowValue.textContent=`${c.glow}px`,e.staggerValue.textContent=`${c.stagger.toFixed(2)}s`,e.scaleValue.textContent=`${c.scale}%`,e.opacityValue.textContent=`${Math.round(c.opacity*100)}%`,e.paddingValue.textContent=`${c.stagePadding}px`}function k(){const t=c.backgroundMode==="gradient"?`linear-gradient(135deg, ${c.backgroundColor}, ${c.backgroundAlt})`:c.backgroundColor;e.stageWrap.style.setProperty("--preview-background",t),e.stageWrap.style.setProperty("--preview-padding",`${c.stagePadding}px`),e.stageWrap.dataset.pattern=c.backgroundPattern,e.stage.style.setProperty("--circuit-color",c.circuitColor),e.stage.style.setProperty("--circuit-bg",c.backgroundColor),e.stage.style.setProperty("--circuit-bg-alt",c.backgroundAlt),e.stage.style.setProperty("--circuit-speed",`${c.speed}s`),e.stage.style.setProperty("--circuit-stroke",`${c.stroke}px`),e.stage.style.setProperty("--circuit-glow",`${c.glow}px`),e.stage.style.setProperty("--circuit-dash",c.dash),e.stage.style.setProperty("--circuit-opacity",c.opacity),e.stage.style.setProperty("--circuit-linecap",c.lineCap),e.stage.style.setProperty("--circuit-linejoin",c.lineJoin),e.stage.style.setProperty("--circuit-node-fill",y()),e.stage.style.setProperty("--circuit-direction",c.animationDirection)}function w(){const t=c.backgroundMode==="gradient"?"linear-gradient(135deg, var(--circuit-bg), var(--circuit-bg-alt))":"var(--circuit-bg)";return`.circuit-surface {
...
}`}function y(){return c.nodeFill==="color"?"var(--circuit-color)":c.nodeFill==="transparent"?"transparent":"var(--circuit-bg)"}function b(t,a){return`Implement this animated SVG circuit in my project.
...
SVG:
${t}`}function S(t){return{svg:e.svgOutput.textContent,css:e.cssOutput.textContent,embed:e.embedOutput.textContent,ai:e.aiOutput.textContent}[t]??""}async function C(t){if(navigator.clipboard?.writeText){await navigator.clipboard.writeText(t);return}const a=document.createElement("textarea");a.value=t,a.setAttribute("readonly",""),a.style.position="fixed",a.style.left="-999px",document.body.append(a),a.select(),document.execCommand("copy"),a.remove()}function V(t){return t.replaceAll("&","&amp;").replaceAll('"',"&quot;").replaceAll("<","&lt;")}x();
